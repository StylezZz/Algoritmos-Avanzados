...
const int P = 200;  // Peso máximo que puede transportar el robot
const int GENERACIONES = 1000;
const double MUTACION = 0.8;
const int POBLACION_INICIAL = 10;

//Pregunta 2B - Christian Carrillo Aburto
...
Individuo seleccionarPadre(const vector<Individuo>& poblacion) {
    ...
    if (totalFitness == 0) {
        // Manejar el caso en que todos los individuos tengan fitness cero
    ...
    // En caso extremo de error, devuelve el primer individuo
    return poblacion[0];
}
...
/*      Esta función se llama al final de generación del genético. 
	ordena la población actual según el peso de mayor a menor. 
	Luego, reduce el tamaño de la población para tener solo las mejores respuestas.*/
...
int main() {
    ...
    for (int generacion = 0; generacion < GENERACIONES; ++generacion) {
        ...
        // Controlar la población para mantener el tamaño y las mejores soluciones
